...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Left.add(jLabel4);
        jLabel4.setBounds(60, 110, 90, 17);
        ...
        Left.add(jLabel5);
        jLabel5.setBounds(60, 210, 90, 17);
...
//        String username = jTextField1.getText();//Store username
//        String password = jTextField2.getText();//Store password
//        
//        if(username.equals("") && password.equals(""))//if username and password is null
//        {
//            JOptionPane.showMessageDialog(null,"Please enter Username and password"); //Dialog bow with message
//        }
//              
//        else{ //if both the fields are present then to login the user, check whether the user exists already
//            //System.out.println("Login connect");
//            Connection connection=connect();// Connect to the dadtabase
//            try 
//            {
